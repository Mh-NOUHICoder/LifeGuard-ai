...
export default function EmergencyExecutionBanner({ execution }: EmergencyExecutionBannerProps) {
  ...
  const isVisible = !!execution && execution.traceId !== dismissedId;
    ...
    <AnimatePresence>
      {isVisible && execution && (
        <motion.div
          ...
          className="fixed top-16 left-4 right-4 md:top-20 md:bottom-auto md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-md z-[60]"
        >
          <div className="bg-[#E10600]/70 border border-white/20 shadow-[0_0_30px_rgba(225,6,0,0.6)] rounded-lg overflow-hidden">
